...
#--------------------------------------------------------------------------------------------------------------------
setwd("C:\\Users\\SHeruwala\\Machine Learning\\R-tutorials\\4-Day R\\Session 1")
...
b=c("24.11.2017 12:50","25.11.2017 12:50","26.11.2017 12:50")

class(b)

#Converting the character elements into date elements

b=dmy_hm(b,tz="Europe/Paris") # by defalut time zone was Universasl UTC

class(b)

b_n = as_date(b) # to convert into the date
...
Date=dmy(a) # remove useless char
...
Mixed_Format=c("1-Jan-15","07/25/2017","2017.07.25")
...
Mixed_Format=parse_date_time(x = Mixed_Format,
...
Mixed_Format=as.Date(Mixed_Format)
